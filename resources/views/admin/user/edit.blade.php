                                ...
                                <div class="mb-3">
                                    ...
                                    <select id="role" name="role" class="form-control" required>
                                        ...
                                        @foreach ($roles as $singleRole)
                                            <option value="{{ $singleRole->id }}" @if($user->role == $singleRole->id) selected @endif>{{ $singleRole->name }}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                                    ...
                                    <div class="inline field">
                                        ...
                                        {{-- <select name="permission[]" multiple class="label ui selection fluid dropdown"> --}}
                                            @foreach ($permissions as $singlePermission)
                                                <option value="{{ $singlePermission->id }}" @if(in_array($singlePermission->id, $userPermissions)) selected @endif>{{ $singlePermission->name }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>

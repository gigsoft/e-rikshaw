...
@section('content')
    ...
    <!-- /.content -->
    <form action="{{ route('admin.sale.store') }}" method="post" id="user-form">
        @csrf
                    ...
                    <div class="row">
                        {{-- <div class="invoice_table_list"> --}}
                           <table class="table table-bordered">
                             ...
                             <tr>
                                <td>
                                    <select name="invoice[0][vehicle_models]" id="vehicle_models_0" class="form-select form-control vehicle_models" required>

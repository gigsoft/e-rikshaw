...
// add role routes
       ...
       Route::get('roles',[RolesController::class,'index'])->name('admin.role');
       Route::get('roles/create',[RolesController::class,'create'])->name('admin.role.create');
       Route::post('roles/store',[RolesController::class,'store'])->name('admin.role.store.add');
       Route::get('roles/edit/{id}',[RolesController::class,'edit'])->name('admin.role.edit');
       Route::post('roles/update/{id}',[RolesController::class,'update'])->name('admin.role.update');
       Route::get('roles/delete/{id}', [RolesController::class, 'destroy'])->name('admin.role.delete');
...
// add permissions routes
       ...
       Route::post('permissions/store',[PermissionsController::class,'store'])->name('admin.permissions.store.add');
       Route::get('permissions/edit/{id}',[PermissionsController::class,'edit'])->name('admin.permissions.edit');
       Route::post('permissions/update/{id}',[PermissionsController::class,'update'])->name('admin.permissions.update');
       Route::get('permissions/delete/{id}', [PermissionsController::class, 'destroy'])->name('admin.permissions.delete');
...
//sales report
     ...
     Route::get('purchase/purchase-data', [ReportController::class, 'getPurchaseData'])->name('admin.getPurcahseData');
...
include_once __DIR__.'/operator.php';
